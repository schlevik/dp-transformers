...
# Inference script for asylax with Llama-3.2-1B-Instruct
dataset_name="asylax"
model_short_name="Llama-3.2-1B-Instruct"

export VLLM_WORKER_MULTIPROC_METHOD=spawn

echo "Starting inference for asylax with Llama-3.2-1B-Instruct"
...
echo "Completed inference for asylax with Llama-3.2-1B-Instruct"
