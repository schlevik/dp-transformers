...
# Inference script for asylax with Llama-3.3-70B-Instruct
dataset_name="asylax"
model_short_name="Llama-3.3-70B-Instruct"

export VLLM_WORKER_MULTIPROC_METHOD=spawn

echo "Starting inference for asylax with Llama-3.3-70B-Instruct"
...
echo "Completed inference for asylax with Llama-3.3-70B-Instruct"
