...
# Inference script for Daniel-ML with Llama-3.2-3B-Instruct
dataset_name="Daniel-ML"
model_short_name="Llama-3.2-3B-Instruct"

export VLLM_WORKER_MULTIPROC_METHOD=spawn

echo "Starting inference for Daniel-ML with Llama-3.2-3B-Instruct"
...
echo "Completed inference for Daniel-ML with Llama-3.2-3B-Instruct"
