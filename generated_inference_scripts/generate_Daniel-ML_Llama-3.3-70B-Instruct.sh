...
# Inference script for Daniel-ML with Llama-3.3-70B-Instruct
dataset_name="Daniel-ML"
model_short_name="Llama-3.3-70B-Instruct"

export VLLM_WORKER_MULTIPROC_METHOD=spawn

echo "Starting inference for Daniel-ML with Llama-3.3-70B-Instruct"
...
echo "Completed inference for Daniel-ML with Llama-3.3-70B-Instruct"
