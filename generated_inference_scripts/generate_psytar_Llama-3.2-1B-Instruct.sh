...
# Inference script for psytar with Llama-3.2-1B-Instruct
dataset_name="psytar"
model_short_name="Llama-3.2-1B-Instruct"

export VLLM_WORKER_MULTIPROC_METHOD=spawn

echo "Starting inference for psytar with Llama-3.2-1B-Instruct"
...
echo "Completed inference for psytar with Llama-3.2-1B-Instruct"
