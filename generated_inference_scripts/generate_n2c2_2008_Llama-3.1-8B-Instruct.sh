...
# Inference script for n2c2_2008 with Llama-3.1-8B-Instruct
dataset_name="n2c2_2008"
model_short_name="Llama-3.1-8B-Instruct"

export VLLM_WORKER_MULTIPROC_METHOD=spawn

echo "Starting inference for n2c2_2008 with Llama-3.1-8B-Instruct"
...
echo "Completed inference for n2c2_2008 with Llama-3.1-8B-Instruct"
